          ...
          {pendingFeedback.length === 0 ? (
            ...
            <div className="space-y-3">
              {pendingFeedback.map((item) => (
                <article key={item.id} className="rounded-lg border border-sand/30 bg-white/60 p-4">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <h3 className="font-headline text-lg text-forest">{item.customer_name}</h3>
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    <button
                      ...
                      className="rounded-lg bg-forest px-4 py-2 text-sm font-bold text-white hover:bg-forest/90 transition disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      className="rounded-lg bg-clay px-4 py-2 text-sm font-bold text-white hover:bg-clay/90 transition disabled:opacity-50"
                    >
                      Delete
                    </button>
                  </div>
                ...
                <article key={item.id} className="rounded-lg border border-sand/30 bg-white/60 p-4">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    <button
                      ...
                      className="rounded-lg bg-moss px-4 py-2 text-sm font-bold text-white hover:bg-moss/90 transition disabled:opacity-50"
                    >
