  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/60 bg-white/95 backdrop-blur-lg">
      <div className="flex w-full items-center gap-2 px-4 py-3 sm:gap-2.5 sm:px-6 md:px-8 md:pr-44 lg:px-16 lg:pr-48 xl:px-24 xl:pr-56">
        <button className="flex items-start gap-2 lg:-ml-3 lg:gap-4" onClick={() => onNavigate('home')}>
          ...
          <div className="min-w-0 text-left">
            ...
            <p className="mt-0.5 hidden truncate text-[11px] font-extrabold tracking-[0.03em] text-forest sm:block sm:text-[13px]">Rooted in Soil, Grown with Care</p>
          </div>
        </button>
        ...
        <div className="ml-auto flex items-center gap-2 md:hidden">
          <a
            ...
            className="inline-flex items-center gap-1.5 rounded-full bg-[#2563eb] px-3 py-2 text-xs font-extrabold text-white transition hover:bg-[#1d4ed8]"
          >
          ...
          <div className="relative">
            <button
              ...
              className="relative inline-flex items-center gap-1 rounded-full bg-forest px-2 py-2 text-xs font-extrabold text-white transition hover:bg-[#1f5c45]"
            >
              <FiShoppingCart className="shrink-0 text-base" />
              <span>Cart</span>
              {cartCount > 0 && (
                <span className="inline-flex min-w-5 items-center justify-center rounded-full bg-white px-1.5 text-[11px] font-black text-forest">
                  {cartCount}
                </span>
              )}
            </button>
      ...
      <div className="absolute right-4 top-3 z-50 hidden items-center gap-3 md:flex">
